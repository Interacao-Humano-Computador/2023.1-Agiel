...
| 04 | Tabelas e figuras utilizadas apresentam legendas e fontes.  | Sim |  |
| 05 | O artefato apresenta um objetivo a ser alcançado com as personas? | Sim | O objetivo não possui seção própria e está contido na introdução |
| 06 | As personas são apresentadas? | Sim | |
| 07 | As personas foram definidas a partir do perfil do usuário? | Sim | |
| 08 | As personas possuem identidade, status, objetivos, habilidades, tarefas, relacionamentos, requisitos e expectativas? | Sim |
| 09 | O elenco de personas é apresentado? | Sim | Quatro personas (duas primárias, uma secundárias e uma antipersona) |
