...
| 03 |  O artefato apresenta as referências utilizadas na sua produção.  | Sim | |
| 04 | Tabelas e figuras utilizadas apresentam legendas e fontes.  | Incompleto | A tabela de Histórico de versões não possui legenda e fonte. |
| 05 |  O artefato identifica e definir claramente os objetivos de usabilidade que serão buscados no projeto ou sistema. | Sim |  |
| 06 | O artefato estabelece critérios mensuráveis e específicos para avaliar se os objetivos de usabilidade foram alcançados.| Sim | |
| 07 | O artefato identifica as principais tarefas que os usuários irão executar no sistema e descrever os requisitos relacionados a essas tarefas.| Sim | |
