...
- Definir tarefas para os participantes realizarem no protótipo 
- Definir o perfil de usuário que será buscado no recrutamento 
- Recrutar os participantes para a avaliação
- Preparar material técnico para registrar a avaliação
- Executar teste piloto

Antes de iniciar a coleta de dados, o grupo deve preparar o material para avaliação, que consiste nos seguintes documentos:
...
- Uma breve descrição do método que será utilizado (teste de usabilidade);
- O número e o perfil dos participantes;
...
A prototipagem de alta fidelidade utiliza materiais que você espera que estejam no produto final e realiza um protótipo que se parece muito mais com algo acabado. [2]
...
- Candidatar para uma vaga de estágio;
- Cadastrar e atualizar currículo;
- Inscrição em processo seletivo;
- Obter dicas sobre a gestão de carreira.
